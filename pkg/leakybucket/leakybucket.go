...
func NewLeakyBucket(limitRules []model.LimitRule) *LeakyBucket {
	return &LeakyBucket{
...
func (lb *LeakyBucket) GetRejectionRule(ip string, now time.Time) *model.LimitRule {
